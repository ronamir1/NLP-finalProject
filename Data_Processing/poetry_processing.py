...
It is assumes that the data will be in Data/public_domain_dump-master from the repository root.
"""
...
def remove_author_and_title(s, author, title):
    s = s.replace(title, "", 1)
...
if __name__ == '__main__':
    ...
    for index, row in catalog_df.iterrows():
        ...
        with open(path, "r", encoding="utf-8") as f:
            ...
            text = remove_author_and_title(text, author, title)
